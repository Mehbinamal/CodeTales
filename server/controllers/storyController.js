...
const generateNarrative = async (repository, insights) => {
  // Check if Gemini is available
  if (!isGeminiAvailable()) {
    console.log('Using fallback narrative generation');
    return generateFallbackNarrative(repository, insights);
  }
